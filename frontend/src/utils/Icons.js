...
export const family = <i class="fa-solid fa-house-signal"></i>
export const friends = <i className="fa-solid fa-user-friends"></i>
export const travel= <i className="fa-solid fa-route"></i>

// export const family = <i className="fa-solid fa-home-heart"></i>
// export const family = <i className="fa-solid fa-home-heart"></i>
